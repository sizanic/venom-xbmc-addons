...
TMDB_GENRES = {
    28:'Action', 12:'Aventure', 16:'Animation', 35:'Com�die', 80:'Crime',99:'Documentaire', 18:'Drame',
    10751:'Familial', 14:'Fantastique', 36:'Histoire', 27:'Horreur', 10402:'Musique', 9648:'Myst�re',
    10749:'Romance', 878:'Science-Fiction', 10770:'T�l�film', 53:'Thriller', 10752:'Guerre', 37:'Western'}
...
#           _meta['credits'] = str(meta['credits']).strip('[]')
    ...
    def _cache_save(self, meta, name, media_type, season, year):
        ...
        # year n'est pas forcement l'ann�e du film mais l'ann�e utilis�e pour la recherche
        try:
    ...
    # retourne la liste des genres en Texte, � partir des IDs
